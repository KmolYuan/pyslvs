...
inline Constraint _P2PDistanceConstraint(int type, Point *point1, Point *point2, double *value) {
    Constraint con;
    con.type = type;
    con.point1 = point1;
    con.point2 = point2;
...
inline Constraint _PointLineConstraint(int type, Point *point1, Line *line1) {
    Constraint con;
    con.type = type;
    con.point1 = point1;
    con.line1 = line1;
...
inline Constraint _P2LDistanceConstraint(int type, Point *point1, Line *line1, double *value) {
    Constraint con;
    con.type = type;
    con.point1 = point1;
    con.line1 = line1;
...
inline Constraint _VerticalHorizontalConstraint(int type, Line *line1) {
    Constraint con;
    con.type = type;
    con.line1 = line1;
    return con;
...
inline Constraint _ArcsConstraint(int type, Arc *arc1, Arc *arc2) {
    Constraint con;
    con.type = type;
    con.arc1 = arc1;
    con.arc2 = arc2;
...
inline Constraint _CirclesConstraint(int type, Circle *circle1, Circle *circle2) {
    Constraint con;
    con.type = type;
    con.circle1 = circle1;
    con.circle2 = circle2;
...
inline Constraint _CircArcConstraint(int type, Circle *circle1, Arc *arc1) {
    Constraint con;
    con.type = type;
    con.circle1 = circle1;
    con.arc1 = arc1;
...
inline Constraint _AngleConstraint(int type, Line *line1, Line *line2, double *value) {
    Constraint con;
    con.type = type;
    con.line1 = line1;
    con.line2 = line2;
...
inline Constraint _PointCircleConstraint(int type, Point *point1, Circle *circle1) {
    Constraint con;
    con.type = type;
    con.point1 = point1;
    con.circle1 = circle1;
...
inline Constraint _PointArcConstraint(int type, Point *point1, Arc *arc1) {
    Constraint con;
    con.type = type;
    con.point1 = point1;
    con.arc1 = arc1;
